...
var share = {
  ...
  htmlL: function(data) {
    ...
    videoHTML = "";
    for (let i = 0; i < 10; i++) {
      videoHTML += `<div class="swiper-slide"><video  class="vid" width="100%" height="100%"  src="http://192.168.1.240:8080/site/dfbinterface/20180830/91633c010e5e4536af77070f978395bf.mp4"></video></div>`;
    }
...
<div class="photo" id="photoImg">
    ...
    <div class="swiper-container">
        <div id="swiperId" class="swiper-wrapper">
        ${imgHTML}
        </div>
